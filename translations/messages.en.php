...
return [
    ...
    "enter_email_txt" => "Enter your email..",
    "phone_txt" => "Phone",
    "enter_name_msg" => "Please enter your name",
    "min_name_two_chars_msg" => "Minimum characters for name are 2 characters long",
    "enter_email_msg" => "Please enter your email",
    "enter_valid_email_msg" => "The email you entered is not valid",
    "enter_valid_phone_number_msg" => "The phone number you entered is not valid",
