 ...
 */
final class Version20220406155657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_spec ADD created DATETIME NOT NULL, ADD creator VARCHAR(255) NOT NULL, ADD modified DATETIME NOT NULL, ADD modified_by VARCHAR(255) NOT NULL, ADD deleted DATETIME DEFAULT NULL, ADD deleted_by VARCHAR(30) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_spec DROP created, DROP creator, DROP modified, DROP modified_by, DROP deleted, DROP deleted_by, CHANGE title title VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE value value VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`');
