 ...
 */
final class Version20220409175912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD absolute_path VARCHAR(255) NOT NULL');
    }
