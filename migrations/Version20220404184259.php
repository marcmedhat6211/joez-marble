 ...
 */
final class Version20220404184259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD price DOUBLE PRECISION NOT NULL, ADD best_seller TINYINT(1) NOT NULL');
    }
