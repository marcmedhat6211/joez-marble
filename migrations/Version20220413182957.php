 ...
 */
final class Version20220413182957 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE material_image (material_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_93DAA811E308AC6F (material_id), INDEX IDX_93DAA8113DA5256D (image_id), PRIMARY KEY(material_id, image_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
