 ...
 */
final class Version20220328214327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD created DATETIME NOT NULL, ADD creator VARCHAR(255) NOT NULL, ADD modified DATETIME NOT NULL, ADD modified_by VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP created, DROP creator, DROP modified, DROP modified_by, CHANGE title title VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
