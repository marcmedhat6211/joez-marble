 ...
 */
final class Version20220329215720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE currency ADD flag_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6956883F919FE4E5 ON currency (flag_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6956883F919FE4E5 ON currency');
        $this->addSql('ALTER TABLE currency DROP flag_id, CHANGE code code VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
