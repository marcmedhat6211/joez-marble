 ...
 */
final class Version20220329175023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE testimonial (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, client VARCHAR(255) DEFAULT NULL, message LONGTEXT DEFAULT NULL, publish TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_E6BDCDF73DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
