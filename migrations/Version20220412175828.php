 ...
 */
final class Version20220412175828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE faq ADD created DATETIME NOT NULL, ADD creator VARCHAR(255) NOT NULL, ADD modified DATETIME NOT NULL, ADD modified_by VARCHAR(255) NOT NULL, ADD deleted DATETIME DEFAULT NULL, ADD deleted_by VARCHAR(30) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE faq DROP created, DROP creator, DROP modified, DROP modified_by, DROP deleted, DROP deleted_by, CHANGE question question LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE answer answer LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
